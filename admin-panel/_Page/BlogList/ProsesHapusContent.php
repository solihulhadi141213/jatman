<?php
    ...
    CURLOPT_URL => ''.$base_url.'/_Api/DeleteBlogContent.php',
    ...
    if($status_response=="success"){
        $_SESSION['NotifikasiSwal']="Hapus Konten Blog Berhasil";
        echo '<span class="text-success" id="NotifikasiHapusContentBerhasil">Success</span>';
        exit();
    }else{
