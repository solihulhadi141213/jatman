<?php
    ...
    $OrderBy    = !empty($_POST['OrderBy']) ? $_POST['OrderBy'] : "datetime_creat";
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => ''.$base_url.'/_Api/ListBlog.php',
    ...
    if($response_arry['status']!=="success"){
        ...
        foreach($data as $list){
            ...
            $datetime_update=$list['datetime_update'];
            ...
            if($publish==1){
                ...
                $label_status='<span class="badge badge-warning">Draft</span>';
            }
            echo '
                <tr>
                    <td align="center"><small>'.$no.'</small></td>
                    <td align="left"><small>'.date('d F Y', strtotime($datetime_creat)).'</small></td>
                    <td align="left">
                        <small>
                            <a href="index.php?Page=BlogList&Sub=DetailBlog&id=' . $id_blog . '" class="text text-decoration-underline">
                                '.$title_blog.'
                            </a>
                        </small>
                    </td>
                    <td align="left"><small>'.$author_blog.'</small></td>
                    <td align="left"><small>'.$label_status.'</small></td>
                    <td align="left">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            ...
                            <li>
                                <a class="dropdown-item" href="index.php?Page=BlogList&Sub=DetailBlog&id=' . $id_blog . '">
                                    <i class="bi bi-info-circle"></i> Detail
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#ModalEdit" data-id="' . $id_blog . '" data-mode="Refresh">
                                    <i class="bi bi-pencil"></i> Edit
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#ModalHapus" data-id="' . $id_blog . '" data-mode="Refresh">
