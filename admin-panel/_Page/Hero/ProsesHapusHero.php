<?php
    ...
    // Validasi input
    $requiredFields = [
        'order'       => 'Order ID Slider Tidak Boleh Kosong!'
    ];
    ...
    CURLOPT_URL => ''.$base_url.'/_Api/DeleteHero.php',
    ...
    if($status_response=="success"){
        echo '<span class="text-success" id="NotifikasiHapusHeroBerhasil">Success</span>';
        exit();
    }else{
