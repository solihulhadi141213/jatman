<?php
    ...
    // Validasi input
    $requiredFields = [
        'kontak_order'       => 'Kontak Order Tidak Boleh Kosong!'
    ];
    ...
    //Buatkan Variabelnya
    $kontak_order=validateAndSanitizeInput($_POST['kontak_order']);

    //Kirim Data Melalui service API
    $curl = curl_init();

    curl_setopt_array($curl, array(
    CURLOPT_URL => ''.$base_url.'/_Api/DeleteKontak.php',
    ...
    if($status_response=="success"){
        $_SESSION['NotifikasiSwal']="Kontak Berhasil Dihapus";
        echo '<span class="text-success" id="NotifikasiDeleteKontakBerhasil">Success</span>';
        exit();
    }else{
