<?php
    ...
    // Validasi input
    $requiredFields = [
        'alamat_title'  => 'Judul Halaman Tidak Boleh Kosong!',
        'alamat_value'  => 'Informasi ALamat Tidak Boleh Kosong!'
    ];
    ...
    //Buatkan Variabelnya
    $alamat_title=$_POST['alamat_title'];
    $alamat_value=$_POST['alamat_value'];
    $alamat_title=validateAndSanitizeInput($_POST['alamat_title']);
    $alamat_value=validateAndSanitizeInput($_POST['alamat_value']);

    //Kirim Data Melalui service API
    $curl = curl_init();

    curl_setopt_array($curl, array(
    CURLOPT_URL => ''.$base_url.'/_Api/UpdateAlamat.php',
    ...
    if($status_response=="success"){
        ...
        echo '<span class="text-success" id="NotifikasiUpdateAlamatBerhasil">Success</span>';
        exit();
    }else{
