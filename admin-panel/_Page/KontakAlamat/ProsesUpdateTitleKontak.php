<?php
    ...
    // Validasi input
    $requiredFields = [
        'kontak_title'      => 'Judul Halaman Tidak Boleh Kosong!',
    ];
    ...
    //Buatkan Variabelnya
    $kontak_title=validateAndSanitizeInput($_POST['kontak_title']);

    //Kirim Data Melalui service API
    $curl = curl_init();

    curl_setopt_array($curl, array(
    CURLOPT_URL => ''.$base_url.'/_Api/UpdateTitleKontak.php',
    ...
    if($status_response=="success"){
        $_SESSION['NotifikasiSwal']="Title Kontak Berhasil Disimpan";
        echo '<span class="text-success" id="NotifikasiUpdateTitleKontakBerhasil">Success</span>';
        exit();
    }else{
