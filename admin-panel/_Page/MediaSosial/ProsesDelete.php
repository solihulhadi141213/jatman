<?php
    ...
    // Validasi input
    $requiredFields = [
        'medsos_order'       => 'Medsos Order Tidak Boleh Kosong!'
    ];
    ...
    //Buatkan Variabelnya
    $medsos_order=validateAndSanitizeInput($_POST['medsos_order']);

    //Kirim Data Melalui service API
    $curl = curl_init();

    curl_setopt_array($curl, array(
    CURLOPT_URL => ''.$base_url.'/_Api/DeleteMedsos.php',
    ...
    if($status_response=="success"){
        $_SESSION['NotifikasiSwal']="Medsos Berhasil Dihapus";
