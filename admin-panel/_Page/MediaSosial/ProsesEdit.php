<?php
    ...
    // Validasi input
    $requiredFields = [
        'medsos_order'  => 'Order Medsos Tidak Boleh Kosong!',
        'icon_medsos'   => 'Icon Medsos Tidak Boleh Kosong!',
        'url_medsos'    => 'URL Medsos Tidak Boleh Kosong!'
    ];
    ...
    //Buatkan Variabelnya
    $medsos_order=$_POST['medsos_order'];
    $icon_medsos=$_POST['icon_medsos'];
    $icon_medsos = addslashes($icon_medsos);
    $url_medsos=validateAndSanitizeInput($_POST['url_medsos']);

    //Kirim Data Melalui service API
    $curl = curl_init();

    curl_setopt_array($curl, array(
    CURLOPT_URL => ''.$base_url.'/_Api/UpdateMedsos.php',
    ...
    if($status_response=="success"){
        $_SESSION['NotifikasiSwal']="Informasi Medsos Berhasil Disimpan";
