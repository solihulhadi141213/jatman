<?php
    ...
    // Validasi input
    $requiredFields = [
        'medsos_title'      => 'Judul Halaman Tidak Boleh Kosong!',
    ];
    ...
    //Buatkan Variabelnya
    $medsos_title=validateAndSanitizeInput($_POST['medsos_title']);

    //Kirim Data Melalui service API
    $curl = curl_init();

    curl_setopt_array($curl, array(
    CURLOPT_URL => ''.$base_url.'/_Api/UpdateTitleMedsos.php',
    ...
    if($status_response=="success"){
        $_SESSION['NotifikasiSwal']="Title Medsos Berhasil Disimpan";
        echo '<span class="text-success" id="NotifikasiUpdateTitleMedsosBerhasil">Success</span>';
        exit();
    }else{
