                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                <small>
                                    Berikut ini adalah halaman untuk mengelola list menu pada website.
                                    Anda bisa menambah struktur menu maupun sub menu di bawahnya.
                                </small>
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-9">
                                            <b class="card-title">Daftar List Menu</b>
                                        </div>
                                        <div class="col-3 text-end">
                                            <button type="button" class="btn btn-md btn-primary btn-floating" data-bs-toggle="modal" data-bs-target="#ModalTambahMenu">
                                    ...
                                    <div class="table table-responsive">
                                        <table class="table table-striped table-hover">
                                            <thead>
                                                <tr>
                                                    <td><b>No</b></td>
                                                    <td colspan="2"><b>Menu/Submenu</b></td>
                                                    <td><b>URL</b></td>
                                                    <td><b>Opsi</b></td>
                                                </tr>
                                            </thead>
                                            <tbody id="ListMenu">
                                                <tr>
                                                    <td colspan="5" class="text-center">
                                                        <small class="text-danger">Tidak Ada Menu Yang Ditampilkan</small>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
