<?php
    ...
    // Validasi input
    $requiredFields = [
        'menu_order_id'        => 'Order ID Tidak Boleh Kosong!'
    ];
    ...
    //Buatkan Variabelnya
    $menu_order_id=validateAndSanitizeInput($_POST['menu_order_id']);

    $curl = curl_init();

    curl_setopt_array($curl, array(
    CURLOPT_URL => ''.$base_url.'/_Api/DeleteMenu.php',
    ...
    if($status_response=="success"){
        echo '<span class="text-success" id="NotifikasiHapusAksesEntitasBerhasil">Success</span>';
        exit();
    }else{
