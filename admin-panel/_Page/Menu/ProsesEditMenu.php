<?php
    ...
    // Validasi input
    $requiredFields = [
        'menu_order_edit'   => 'Order Menu Tidak Boleh Kosong!',
        'menu_label_edit'   => 'Label Menu Tidak Boleh Kosong!',
        'menu_url_edit'     => 'Menu URL Tidak Boleh Kosong!'
    ];
    ...
    //Buatkan Variabelnya
    $menu_order_edit=validateAndSanitizeInput($_POST['menu_order_edit']);
    $menu_label_edit=validateAndSanitizeInput($_POST['menu_label_edit']);
    $menu_url_edit=validateAndSanitizeInput($_POST['menu_url_edit']);

    //Kirim Data Melalui service API
    $curl = curl_init();

    curl_setopt_array($curl, array(
    CURLOPT_URL => ''.$base_url.'/_Api/UpdateMenu.php',
    ...
    if($status_response=="success"){
        echo '<span class="text-success" id="NotifikasiEditMenuBerhasil">Success</span>';
        exit();
    }else{
