<?php
    ...
    // Validasi input
    $requiredFields = [
        'menu_label'        => 'Label Menu Tidak Boleh Kosong!',
        'menu_url'          => 'Menu URL Tidak Boleh Kosong!'
    ];
    ...
    //Buatkan Variabelnya
    $menu_label=validateAndSanitizeInput($_POST['menu_label']);
    $menu_url=validateAndSanitizeInput($_POST['menu_url']);

    //Kirim Data Melalui service API
   $curl = curl_init();

    curl_setopt_array($curl, array(
    CURLOPT_URL => ''.$base_url.'/_Api/InsertMenu.php',
    ...
    if($status_response=="success"){
        echo '<span class="text-success" id="NotifikasiTambahMenuBerhasil">Success</span>';
        exit();
    }else{
