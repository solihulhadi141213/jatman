<?php
    ...
    // Validasi input
    $requiredFields = [
        'menu_order'            => 'Menu Order Tidak Boleh Kosong!',
        'submenu_label'        => 'Label Menu Tidak Boleh Kosong!',
        'submenu_url'          => 'Menu URL Tidak Boleh Kosong!'
    ];
    ...
    //Buatkan Variabelnya
    $menu_order=validateAndSanitizeInput($_POST['menu_order']);
    $submenu_label=validateAndSanitizeInput($_POST['submenu_label']);
    $submenu_url=validateAndSanitizeInput($_POST['submenu_url']);

    //Kirim Data Melalui service API
   $curl = curl_init();

    curl_setopt_array($curl, array(
    CURLOPT_URL => ''.$base_url.'/_Api/InsertSubMenu.php',
    ...
    if($status_response=="success"){
        echo '<span class="text-success" id="NotifikasiTambahSubmenuBerhasil">Success</span>';
        exit();
    }else{
