<?php
    ...
    // Validasi input
    $requiredFields = [
        'tautan_lainnya_order'       => 'ID Order Tidak Boleh Kosong!'
    ];
    ...
    //Buatkan Variabelnya
    $tautan_lainnya_order=validateAndSanitizeInput($_POST['tautan_lainnya_order']);

    //Kirim Data Melalui service API
    $curl = curl_init();

    curl_setopt_array($curl, array(
    CURLOPT_URL => ''.$base_url.'/_Api/DeleteTautanLainnya.php',
    ...
    if($status_response=="success"){
        $_SESSION['NotifikasiSwal']="Tautan Berhasil Dihapus";
        echo '<span class="text-success" id="NotifikasiDeleteBerhasil">Success</span>';
        exit();
    }else{
