<?php
    ...
    // Validasi input
    $requiredFields = [
        'tautan_lainnya_order'  => 'Order ID Tidak Boleh Kosong!',
        'label_tautan'  => 'Label Tidak Boleh Kosong!',
        'url_tautan'    => 'URL Tidak Boleh Kosong!',
        'target_tautan'         => 'Target Tidak Boleh Kosong!',
    ];
    ...
    //Buatkan Variabelnya
    $tautan_lainnya_order=$_POST['tautan_lainnya_order'];
    $label_tautan=$_POST['label_tautan'];
    $url_tautan=$_POST['url_tautan'];
    $target_tautan=$_POST['target_tautan'];

    //Kirim Data Melalui service API
    $curl = curl_init();

    curl_setopt_array($curl, array(
    CURLOPT_URL => ''.$base_url.'/_Api/UpdateTautanLainnya.php',
    ...
    if($status_response=="success"){
        $_SESSION['NotifikasiSwal']="Informasi Tauan Berhasil Disimpan";
