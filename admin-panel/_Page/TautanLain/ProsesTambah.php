<?php
    ...
    // Validasi input
    $requiredFields = [
        'label_tautan'      => 'Label Tautan Tidak Boleh Kosong!',
        'url_tautan'        => 'URL Tautan Tidak Boleh Kosong!',
        'target_tautan'     => 'Target Tautan Tidak Boleh Kosong!'
    ];
    ...
    CURLOPT_URL => ''.$base_url.'/_Api/InsertTautanLainnya.php',
    ...
    if($status_response=="success"){
        $_SESSION['NotifikasiSwal']="Informasi Tautan Berhasil Disimpan";
