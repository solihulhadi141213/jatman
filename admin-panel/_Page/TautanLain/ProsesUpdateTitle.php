<?php
    ...
    // Validasi input
    $requiredFields = [
        'tautan_lainnya_title'      => 'Judul Halaman Tidak Boleh Kosong!',
    ];
    ...
    //Buatkan Variabelnya
    $tautan_lainnya_title=validateAndSanitizeInput($_POST['tautan_lainnya_title']);

    //Kirim Data Melalui service API
    $curl = curl_init();

    curl_setopt_array($curl, array(
    CURLOPT_URL => ''.$base_url.'/_Api/UpdateTitleTautanLainnya.php',
    ...
    if($status_response=="success"){
        $_SESSION['NotifikasiSwal']="Title Tautan Lainnya Berhasil Disimpan";
        echo '<span class="text-success" id="NotifikasiUpdateTitleBerhasil">Success</span>';
        exit();
    }else{
