<?php
    ...
    // Validasi input
    $requiredFields = [
        'title_visi_misi'   => 'Judul Halaman Tidak Boleh Kosong!',
        'visi'              => 'Visi Tidak Boleh Kosong!',
        'misi'              => 'Misi Tidak Boleh Kosong!',
        'motto'             => 'Moto Tidak Boleh Kosong!'
    ];
    ...
    curl_setopt_array($curl, [
        CURLOPT_URL            => $base_url.'/_Api/UpdateVisiMisi.php',
    ...
    if($status_response=="success"){
        $_SESSION['NotifikasiSwal']="Visi Dan Misi Berhasil Disimpan";
