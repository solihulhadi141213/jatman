...
<aside id="sidebar" class="sidebar menu_background">
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link <?php if($PageMenu=="Metatag"||$PageMenu=="Favicon"||$PageMenu=="Navbar"||$PageMenu=="Menu"||$PageMenu=="KontakAlamat"||$PageMenu=="MediaSosial"||$PageMenu=="TautanLain"){echo "";}else{echo "collapsed";} ?>" data-bs-target="#layout-nav" data-bs-toggle="collapse" href="javascript:void(0);">
                <i class="bi bi-columns"></i>
                <span>Layout</span>
                <i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="layout-nav" class="nav-content collapse <?php if($PageMenu=="Metatag"||$PageMenu=="Favicon"||$PageMenu=="Navbar"||$PageMenu=="Menu"||$PageMenu=="KontakAlamat"||$PageMenu=="MediaSosial"||$PageMenu=="TautanLain"){echo "show";} ?>" data-bs-parent="#sidebar-nav">
                <li>
